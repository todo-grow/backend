...
class AuthService:
    ...
    async def get_kakao_user_info(self, access_token: str) -> Optional[Dict[str, Any]]:
        ...
        return await self._auth_provider.get_user_info(access_token)

    async def get_access_token_from_code(
        self, code: str, client_id: str, client_secret: str, redirect_uri: str
    ) -> Optional[str]:
        """카카오 인증 코드로 액세스 토큰 가져오기"""
        return await self._auth_provider.get_access_token_from_code(
    ...
    async def unlink_kakao_account(self, kakao_id: str) -> bool:
        ...
        return await self._auth_provider.unlink_account(kakao_id)
